...
/*
    DLL Injection technique done (2 days)
*/

#define MESSAGE_STRING "STATUS: DLL Injection Success!"
#define PIXEL_SIZE_OFFSET 60 // pixel offset is dependant upon the font size, style, and other features/factors, etc

#pragma comment(lib, "user32.lib")
#pragma comment(lib, "gdi32.lib")

// LPARAM - Long parameter (32 bits), WPARAM - Word parameter (16 bits)
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD ul_reason_for_call, LPVOID lpReserved)
{
    switch (ul_reason_for_call) {
        case DLL_PROCESS_ATTACH:
        {
            ...
            windowClass.hCursor = LoadCursor(NULL, IDC_ARROW); // a handle to the mouse cursor when positioned over the main window
            ...
            */
            ...
            HWND hwnd = CreateWindow("TESTWINDOWCLASS\0", "Generic DLL Injector v0.1",
                            ...
                            WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, // CW = Create Window
                            600, 300, NULL, NULL, hInstance, NULL
            );
            ...
            TextOut(hdc, 10, 10, MESSAGE_STRING, 8); // 8 = "STATUS: " (length of uncolored text)

            // Initialize text color
            SetTextColor(hdc, RGB(0, 255, 0)); // GREEN
            TextOut(hdc, 10 + PIXEL_SIZE_OFFSET, 10, MESSAGE_STRING + 8, 22);
